        ...
        <b-col>
          ...
          <b-table striped
            ...
            <template v-slot:cell(acciones)="row">
              <b-button @click="almacenarDatos(row)" href="/seguimiento" size="sm"  class="mr-2" variant="link"><b-img center=""  src="@/static/images/revisar.png" width="40" height="40"></b-img>Revisar</b-button>
            </template>
          </b-table>
        </b-col>
      </b-row>
